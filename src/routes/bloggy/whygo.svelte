...
<h3>I Love Go because of it's simplicity.</h3> <br>
<div class="body">
<p>What does this mean? I am referring to its api and it's ability to uncouple code.
...
<pre>
<code>
{`type Guitarist struct{Guitarist } //object
